...

{
  ...
  category: "Boissons",
  subCategory: "boissons alcoolisées",
  image: "/assets/images/Boissons/chenet_cabernet_blanc.png",
  details: "Un vin français raffiné, parfait pour un moment de détente ou un repas entre amis."
},

{
  id: 228,
  name: "Chenet Cabernet Rosé 25cl",
  description: "Vin rouge élégant, aux arômes riches et fruités, idéal pour accompagner vos plats",
  takeawayPrice: 4.50,
  price: 5.00,
  category: "Boissons",
  subCategory: "boissons alcoolisées",
  image: "/assets/images/Boissons/chenet_cabernet_rose.png",
  details: "Un vin français raffiné, parfait pour un moment de détente ou un repas entre amis."
},

{
  id: 2028,
  name: "Cellier des Dauphins Blanc 25cl",
  description: "Vin rouge élégant, aux arômes riches et fruités, idéal pour accompagner vos plats",
  takeawayPrice: 4.50,
  price: 5.00,
  category: "Boissons",
  subCategory: "boissons alcoolisées",
  image: "/assets/images/Boissons/cellier_dauphins_blanc.png",
  details: "Un vin français raffiné, parfait pour un moment de détente ou un repas entre amis."
},

{
  id: 2030,
  name: "Cellier des Dauphins Rosé 25cl",
  description: "Vin rosé frais et léger, aux arômes fruités, parfait pour les apéritifs et repas légers",
  takeawayPrice: 4.50,
  price: 5.00,
  category: "Boissons",
  subCategory: "boissons alcoolisées",
  image: "/assets/images/Boissons/cellier_dauphins_rose.png",
  details: "Un rosé élégant et rafraîchissant, idéal pour partager de bons moments."
},

{
  id: 2029,
  name: "Cellier des Dauphins Rouge 25 cl",
  description: "Vin rouge souple et généreux, aux notes de fruits rouges mûrs et d’épices",
  takeawayPrice: 4.50,
  price: 5.00,
  category: "Boissons",
  subCategory: "boissons alcoolisées",
  image: "/assets/images/Boissons/cellier_dauphins.png",
  details: "Un vin du sud de la France, parfait pour accompagner viandes, grillades et bons moments.",
  ...
  },
 {
  ...
  description: "Bière stout venu du Cameroun au goût corsé et crémeux",
  takeawayPrice: 4.50,
  price: 5.00,
  category: "Boissons",
  subCategory: "boissons alcoolisées",
