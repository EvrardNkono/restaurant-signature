...
import PwaInstallPrompt from './PwaInstallPrompt'; // adapte le chemin si besoin
...
const Banner = () => {
  ...
  return (
    <div className="banner" style={{ backgroundImage: `url(${images[currentImageIndex]})` }}>
      ...
      {/* Le popup PWA s’affichera tout seul quand possible */}
      <PwaInstallPrompt />
      ...
      <div className="contact-floating-card">
        ...
        <div className="social-icons">
          <a href="https://www.instagram.com/restaurantsignature" target="_blank" rel="noopener noreferrer" className="icon-instagram">
            <FontAwesomeIcon icon={faInstagram} />
          </a>
          <a href="https://www.tiktok.com/@restaurantsignature" target="_blank" rel="noopener noreferrer" className="icon-tiktok">
            <FontAwesomeIcon icon={faTiktok} />
          </a>
          <a href="https://www.facebook.com/restaurantsignature" target="_blank" rel="noopener noreferrer" className="icon-facebook">
            <FontAwesomeIcon icon={faFacebookF} />
          </a>
          <a href="https://wa.me/33644951184" target="_blank" rel="noopener noreferrer" className="icon-whatsapp">
